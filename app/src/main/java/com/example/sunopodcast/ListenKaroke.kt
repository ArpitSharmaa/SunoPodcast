...
class ListenKaroke : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_listen_karoke, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            findNavController().navigate(R.id.action_listenKaroke_to_karokelistfrag)
        }
